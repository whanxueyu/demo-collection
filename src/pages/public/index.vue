    ...
    <el-container class="common-layout">
        <el-header>
            <el-menu :default-active="menu.activeIndex" class="el-menu-demo" mode="horizontal" :ellipsis="false"
                ...
                <div class="el-menu-item" @click="github">
                    <!-- <el-icon size="56" class="giticon">
                        <svg t="1685599271703" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="4406" width="128" height="128">
                            <path
                                ...
                                fill="#fff" p-id="4407"></path>
                        </svg>
                    </el-icon> -->
                    <div class="github">
                        <a href="https://github.com/whanxueyu/demo-collection" target="_blank">
                            <img src="https://img.shields.io/github/stars/whanxueyu/demo-collection?style=social" alt="GitHub stars">
                        </a>
                    </div>
                </div>
                <div class="flex-grow" />
