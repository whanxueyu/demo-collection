<template>
    <div class="bigdata">
        <div class="side">
            <el-icon :class="state.showAll ? 'star active' : 'star'" size="40px"
                @click="state.showAll = !state.showAll">
                <svg t="1685694092016" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="2384" width="128" height="128">
                    <path
            ...
            <el-button type="primary" plain @click="iframeFullScreen">
                <el-icon>
        ...
        <iframe class="frame" id="iframe" v-else :src="state.url"></iframe>
    </div>
</template>
...
const iframeFullScreen = () => {
    let inner = document.getElementById('iframe')
